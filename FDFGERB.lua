...
{
{text = 'قناة السورس', url='https://t.me/be49_bot'},
},
}
}
...
{
{text = '𝑺𝒐𝒖𝒓𝒄𝒆', url='https://t.me/be49_bot'},
},
}
}
LuaTele.sendText(msg_chat_id,msg_id,[[
...
{
{text = 'قناة السورس',url="t.me/be49_bot"}
},
}
...
data = {
{
{text = '❲ 𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓🎖 ❳', url = "https://t.me/be49_bot"}
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,"[ReBack Source .](t.me/be49_bot)\n\n[سورس ريباك ،](t.me/be49_bot)","md",true, false, false, false,reply_markup)
end
...
local CmdStart = '\n• اهلين انا  '..(Redis:get(FDFGERB.."FDFGERB:Name:Bot") or "FDFGERB")..
...
{
{text = 'تحديثات لبوت', url = 't.me/Be49_Bot'}, 
},
}
}
